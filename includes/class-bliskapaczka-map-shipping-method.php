...
class Bliskapaczka_Map_Shipping_Method extends Bliskapaczka_Shipping_Method_Base {
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
            ...
            $helper::SENDER_COMPANY  => array(
                'title'             => __( 'Company name', 'bliskapaczka-pl' ),
                'type'              => 'text',
            ),
    ...
    public function validate_BLISKAPACZKA_SENDER_COMPANY_field( $key, $value ) {
        if ( strlen( $value ) > 50 ) {
            WC_Admin_Settings::add_error( esc_html__( 'Company name is longer than 50 characters.', 'bliskapaczka-pl' ) );
            return;
        }
        return ( $value );
    }
