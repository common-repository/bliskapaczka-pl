...
= 1.5.0 =
Nowa wtyczka:
* posiada możliwość potwierdzania przesyłek z poziomu platformy sklepu
* oferuje pobieranie dokumentów przewozowych
* zapisuje w zamówieniu informacje o sposobie dostawy, jaką wybrał klient
* jest kompatybilna z najnowszą wersją wtyczki Flexible Shipping
* zawiera poprawki dla zgłaszanych błędów

= 1.5.1 =
* optymalizacja skryptów wtyczki
* poprawa widoczności ikonki SteetView na mapie z punktami
* poprawa szczegółów zlecenia
...
= 1.5.0 =
Dodanie obsługi zleceń bliskapaczka.pl z poziomu platformy sklepu.

= 1.5.1 =
Optymalizacja i poprawa błędów